 ...
 *
 * <p>Unknown constraints fall back to the generic {@code field.invalid}.
 *
 * <p>The same translator lives on the BFF side
 * ({@code bff/.../adapter/in/web/JakartaCodeTranslator.java}) — both copies
 * stay in sync via the prompt and the phase verification script.
 */
