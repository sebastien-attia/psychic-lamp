 ...
 *
 * <p>Imported by {@link ch.owt.boatapp.BusinessServiceApplicationTests} and
 * by every {@link ch.owt.boatapp.integration.IntegrationTestBase} subclass.
 * Public so test classes in sibling packages can {@code @Import} it.
 */
